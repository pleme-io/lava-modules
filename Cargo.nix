    ...
    crates = {
      ...
      "lava-core" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2a99a06a1609bb969361f8917865324f86b9d172";
          sha256 = "0g2msia2cv6nv308nfbkhc1mbwd5758pdrxnwj0jh1hbi0lgrhp1";
        };
        libName = "lava_core";
        authors = [
          "pleme-io"
      ...
      "lava-modules" = rec {
        crateName = "lava-modules";
        version = "0.1.3";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./.; };
        libName = "lava_modules";
        authors = [
          "pleme-io"
        ];
        dependencies = [
